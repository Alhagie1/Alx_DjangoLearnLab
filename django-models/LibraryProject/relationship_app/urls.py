...
urlpatterns = [
    ...
    path("add_book/", views.add_book.as_view(), name="add book"),
    path("edit_book/", views.edit_book.as_view(),name="edit book"),
    path("delete_book/", views.delete_book.as_view(), name="delete book"),
]